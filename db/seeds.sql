...
VALUES
    (
        'JS Juggernauts',
        'The JS Juggernaut eat, breather, and sleep JavaScript. They can build everything you could ever want in SJ, including a new kitchen sink.'
    ),
    (
        'Heroes of HTML',
